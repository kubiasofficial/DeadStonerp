...
export const env = {
  ...
  discordTicketWaitingCategoryId: process.env.DISCORD_TICKET_WAITING_CATEGORY_ID || "1532300903598788699",
  discordTicketActiveCategoryId: process.env.DISCORD_TICKET_ACTIVE_CATEGORY_ID || "1532301023161487402",
  discordTicketClosedCategoryId: process.env.DISCORD_TICKET_CLOSED_CATEGORY_ID || "1532301099145363516",
